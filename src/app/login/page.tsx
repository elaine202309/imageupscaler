...
export default function LoginPage() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4" style={{ background: "var(--gradient-subtle)" }}>
      <Card className="w-full max-w-md glass border-0 shadow-xl">
        <CardHeader className="text-center pb-2">
          <CardTitle className="text-2xl font-bold">
            Sign In to <span className="gradient-text">ImageUpscaler</span>
          </CardTitle>
          <p className="text-sm text-muted-foreground mt-2">
            Get 5 free credits/month and track your upscale history
          </p>
        </CardHeader>
